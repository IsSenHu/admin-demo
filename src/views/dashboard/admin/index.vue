...
export default {
  ...
  methods: {
    ...
    checkChartData(start, end) {
      ...
      requestByClient(Xxl, 'post', '/newChartInfo?startDate=' + startDate + '&endDate=' + endDate, null, resp => {
        ...
        if (code === 0 && data) {
          ...
          lineChartData.xAxis.triggerDayList = data.triggerDayList
          lineChartData.xAxis.triggerDayCountRunningList = data.triggerDayCountRunningList
          lineChartData.xAxis.triggerDayCountSucList = data.triggerDayCountSucList
          lineChartData.xAxis.triggerDayCountFailList = data.triggerDayCountFailList
          this.lineChartData = lineChartData

          const counts = {}
          counts.groupCount = data.executorCount
          counts.jobCount = data.jobInfoCount
          counts.triggerTimes = data.jobLogCount
          this.counts = counts

          const pieChart = {}
          pieChart.legendData = ['进行中', '成功', '失败']
          pieChart.values = [{
            name: '成功',
